...
public class CheckingAccount extends Account {
	...
	/*
	 * Output of the unit test Account name: Steve Jobs, Account Type:
	 * CheckingAccount, Balance: $50.00 Account name: Steve Jobs, Account Type:
	 * CheckingAccount, Balance: $39.75 Account name: Steve Jobs, Account Type:
	 * CheckingAccount, Balance: $36.75 Account name: Steve Jobs, Account Type:
	 * CheckingAccount, Balance: $1000036.75
	 */
}
